  ...
  de: {
    ...
    nav: {
      links: [
        ...
        // { label: 'Sozialistische KI', href: '#socialist-ai' }, // temporarily removed with the Socialist section
      ],
      getApp: 'App holen',
    ...
    footer: {
      ...
      copyright: '© 2026 Plausch · Künstliche Intelligenz als öffentliches Gut. Entwickelt in Europa. 🇪🇺',
    },
  ...
  en: {
    ...
    nav: {
      links: [
        ...
        // { label: 'Socialist AI', href: '#socialist-ai' }, // temporarily removed with the Socialist section
      ],
      getApp: 'Get the App',
    ...
    footer: {
      ...
      socialistAiLabel: 'Socialist AI',
      copyright: '© 2026 Plausch · Making artificial intelligence a public good. Developed in Europe. 🇪🇺',
    },

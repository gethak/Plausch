...
export const translations = {
  de: {
    ...
    hero: {
      ...
      bodyShort: 'Jedes führende KI-Modell — in einer App. Finde das Modell, das zu dir passt.',
    ...
    oneApp: {
      ...
      body: 'Wechsle an einem Ort zwischen den besten KI-Modellen der Welt. Vergleiche Antworten, entdecke Stärken und hol mehr aus jedem Gespräch.',
      moreLabel: 'Mehr',
      phoneAlt: 'Plausch App — Modellauswahl',
    },
    privacyBand: {
      heading: 'Deine Privatsphäre. Unsere Priorität.',
      body: 'Wir verkaufen deine Daten nicht. Deine Gespräche bleiben privat, sicher und unter deiner Kontrolle.',
      cta: 'Mehr zum Datenschutz',
    },
  ...
  en: {
    ...
    hero: {
      ...
      bodyShort: 'Every leading AI model — in one app. Find the one that truly fits you.',
    ...
    oneApp: {
      ...
      body: "Switch between the world's best AI models in one place. Compare answers, explore capabilities, and get more from every conversation.",
      moreLabel: 'More',
      phoneAlt: 'Plausch app — model picker',
    },
    privacyBand: {
      heading: 'Your privacy. Our priority.',
      body: "We don't sell your data. Your conversations stay private, secure, and under your control.",

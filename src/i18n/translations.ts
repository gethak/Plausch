...
export const translations = {
  de: {
    ...
    hero: {
      ...
      eyebrowLine2: '- Von den besten KI-Modellen.',
      h1Line1: 'Deine KI.',
      h1Line2: 'Weltweit.',
      body: 'ChatGPT, Claude, Gemini, Kimi, Deepseek, Mistral und viele mehr - All diese KI-Modelle in einer App - Plausch',
  ...
  en: {
    ...
    hero: {
      eyebrow: 'Get second opinions on your most important questions',
      eyebrowLine2: '- From the best AI models.',
      h1Line1: 'Your AI.',
      h1Line2: 'Worldwide.',
      body: 'ChatGPT, Claude, Gemini, Kimi, Deepseek, Mistral, and many more - All these AI models in one app - Plausch',

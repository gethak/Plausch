  ...
  return (
    <div className="relative overflow-hidden rounded-[2rem] bg-[#f5efe3] shadow-sm ring-1 ring-[#17130e]/10">
      <img
        ...
        loading="lazy"
        className="pointer-events-none w-full select-none md:absolute md:right-0 md:top-0 md:h-full md:w-auto"
      />
      <div
        aria-hidden
        className="absolute inset-y-8 left-8 hidden w-px flex-col items-center gap-3 md:flex"
      >
        <span className="w-px flex-1 bg-[#e07b39]/40" />
        <Heart className="h-4 w-4 shrink-0 -translate-x-1/2 text-[#e07b39]" strokeWidth={1.5} />
        <span className="w-px flex-1 bg-[#e07b39]/40" />
      </div>
      <div className="relative -mt-8 px-7 pb-12 sm:mt-0 sm:px-12 md:px-20 md:py-16">
        ...
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="z-10 mt-8 inline-flex items-center gap-2 rounded-full bg-white px-6 py-3.5 text-sm font-bold text-[#17130e] shadow-sm ring-1 ring-[#17130e]/5 transition-transform hover:scale-[1.04] active:scale-95 md:absolute md:bottom-8 md:right-8 md:mt-0"
        >
          {t.palestine.cta}
